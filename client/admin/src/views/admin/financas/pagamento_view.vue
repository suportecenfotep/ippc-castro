                    ...
                    .then(res => {
                        if (res.data) {
                            ...
                            const desenharFatura = (xOffset, titulo, faturas) => {
                                ...
                                doc.setFontSize(7.5);
                                doc.text('INSTITUTO POLITÉCNICO PRIVADO CASTRO', xOffset + 32, 11);
                                doc.setFontSize(7);
                                doc.text('NIF: 50002047 | Tel: +244 939 237 968', xOffset + 32, 15);
                                doc.text('Huambo, Estrada Nacional 260, Bomba Baixa', xOffset + 32, 19);
                                doc.text('Email: ippc23@gmail.com', xOffset + 32, 23);
                                
                                // INSERÇÃO DO REGIME DA EMPRESA
                                doc.setFont(undefined, 'bold');
                                doc.text('Regime: Regime Simplificado', xOffset + 32, 27);
